...
--     pylsp = {
--       plugins = {
--         -- This handles things like "unused imports" and "undefined variables"
--         pyflakes = { enabled = true },
--         -- This handles code style (indentation, etc.)
--         pycodestyle = {
--           enabled = true,
--           maxLineLength = 100,
--         },
--         -- This provides the "Go to Definition" and "Autocomplete"
...
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
        ...
        local client =
            vim.lsp.start(vim.tbl_extend("force", vim.lsp.config.basedpyright, { root_dir = root }), { attach = true })
        if client then
